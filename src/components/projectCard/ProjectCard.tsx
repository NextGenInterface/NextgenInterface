...
const ProjectCard = ({
  ...
  return (
    <Link
      ...
      <article className="group:active:scale-95 bg-light-foreground group-hover:bg-neutral-200 dark:group-hover:bg-neutral-800 flex dark:bg-dark-foreground  overflow-hidden ">
